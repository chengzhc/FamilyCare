...
public class CzTimeSelector {
    ...
    public CzTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    public CzTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
...
//    }
    ...
    public void show(long currentStamp) {
    ...
    private void initParameter(long currentStamp) {
        ...
        selectedCalender.setTime(new Date(currentStamp*1000));
    }
    ...
    private void loadComponent() {
        ...
        year_pv.setSelected(selectedYear-startYear);
        int selectedMonth=selectedCalender.get(Calendar.MONTH)+1;
        month_pv.setSelected(selectedMonth-startMonth);
        int selectedDay=selectedCalender.get(Calendar.DAY_OF_MONTH);
        day_pv.setSelected(selectedDay-startDay);
        int selectedHour=selectedCalender.get(Calendar.HOUR);
        hour_pv.setSelected(selectedHour-startHour);
        int selectedMonute=selectedCalender.get(Calendar.MINUTE);
        minute_pv.setSelected(selectedMonute-startMininute);
        excuteScroll();
    }
